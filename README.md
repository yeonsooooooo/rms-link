...
- [외부 대시보드](https://ys-macmini.tail984bfd.ts.net:8443/): 관리자 접속 코드로 로그인. 내부와 같은 데이터·화면을 제공합니다.
...
Windows x64, Windows 10 1809 이상을 대상으로 합니다. 로그인 세션 안에서 동작하며 잠금·최소화·지원하지 않는 캡처 화면은 현장 확인이 필요합니다. .NET 런타임을 포함한 설치 파일을 제공합니다.
